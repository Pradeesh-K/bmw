...
export default function Footer() {
  ...
  return (
   ...
   <div  className="d-flex ">
          ...
          {localStorage.getItem('username') ? <button onClick={handleLogout} className="links">logout |</button> : localStorage.getItem('dbToken') ? <button onClick={handleLogoutOtp} className="links">logout |</button> :<Link to={`/login`} style={{ textDecoration: "none" }}> 
